		...
		<div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-12 mb-20">
			...
			<div class="lg:col-span-2">
				<a href="/" class="flex items-center gap-3 mb-8">
					...
					<span class="text-xl font-semibold tracking-tight">Smart Operator</span>
				</a>
                
                <div class="mt-20">
                    <a href="mailto:sales@smart-operator.ai" class="text-sm font-medium border-b border-white pb-1 hover:opacity-80 transition-opacity inline-block">Contact us</a>
                    <div class="text-[10px] text-gray-500 mt-4">© Smart Operator 2025</div>
                </div>
			</div>

			<!-- Column 1 -->
			<div>
				<h4 class="text-xs font-bold text-gray-500 uppercase tracking-wider mb-6">Platform</h4>
				<ul class="space-y-3 text-sm text-gray-300">
					<li><a href="#platform" class="hover:text-white transition-colors">Overview</a></li>
					<li><a href="#features" class="hover:text-white transition-colors">Voice Activation</a></li>
					<li><a href="#features" class="hover:text-white transition-colors">Living SOPs</a></li>
					<li><a href="#features" class="hover:text-white transition-colors">Knowledge Capture</a></li>
					<li><a href="#" class="hover:text-white transition-colors">iOS App</a></li>
					<li><a href="#" class="hover:text-white transition-colors">Android App</a></li>
			...
			<div>
				...
				<ul class="space-y-3 text-sm text-gray-300">
					<li><a href="#solutions" class="hover:text-white transition-colors">Hotels & Resorts</a></li>
					<li><a href="#solutions" class="hover:text-white transition-colors">Restaurants</a></li>
					<li><a href="#solutions" class="hover:text-white transition-colors">Event Venues</a></li>
					<li><a href="#solutions" class="hover:text-white transition-colors">Cruise Lines</a></li>
					<li><a href="#solutions" class="hover:text-white transition-colors">Multi-Site Operations</a></li>
					<li><a href="#" class="hover:text-white transition-colors">Case Studies</a></li>
					<li><a href="#testimonials" class="hover:text-white transition-colors">Customer Stories</a></li>
			...
			<div>
				...
				<ul class="space-y-3 text-sm text-gray-300">
					...
					<li><a href="mailto:sales@smart-operator.ai" class="hover:text-white transition-colors">Contact Sales</a></li>
